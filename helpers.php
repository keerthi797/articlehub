...
define('APP_URL', 'http://localhost/article-dashboard/');
...
function requireAuth(): array {
    ...
    $db    = getDB();
    $stmt  = $db->prepare("SELECT u.id, u.name, u.email, u.role, u.job_title, u.org, u.avatar
        FROM sessions s
...
function getSetting(string $key, mixed $default = null): mixed {
    ...
    // Try to decode as JSON first, otherwise return as string
